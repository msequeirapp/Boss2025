        ...
        <div className="grid grid-cols-1 gap-10">
          ...
          >
            ...
            <div className="mt-8 text-center">
              <h3 className="font-semibold mb-6 text-xl">{t.followUs}</h3>
              <div className="flex flex-wrap justify-center gap-6">
                ...
                <a
                  ...
                  className="flex flex-col items-center p-4 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all hover:text-melody-fuchsia hover:scale-105 w-36"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="currentColor" className="mb-2">
                    <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                  </svg>
                  <span>Facebook</span>
                </a>
                ...
                {/* Email */}
                <a
                  href="mailto:bossofmelodycr@gmail.com"
                  className="flex flex-col items-center p-4 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all hover:text-melody-fuchsia hover:scale-105 w-36"
                >
